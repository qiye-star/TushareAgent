...
def build_research_graph(
    ...
    *,
    ...
    g.add_node("tool_rag", make_tool_rag(llm, tools, tool_defs, max_tokens=max_tokens, base_system=base_system))
    ...
    g.add_conditional_edges("router", route_after_router, {"tool_rag": "tool_rag", "fallback": "fallback"})
