...
_ENV_KEYS = [
    ...
    "TUSHARE_MCP_URL", "DEMO_DATABASE_URL",
    "DEMO_MCP_KEEPALIVE", "TOOL_POOL_HOT_START",
    "MCP_GATEWAY_URL", "MCP_GATEWAY_ADMIN_URL",
    "TOOL_MAX_REVEALED", "TOOL_META_ALWAYS", "TOOL_PROBE_ENABLED",
    "TOOL_PROBE_CACHE_PATH", "TOOL_PROBE_CONCURRENCY",
    "WIND_API_KEY", "WIND_ENABLED",
    "QUICKREPORT_ENABLED", "QUICKREPORT_AUTO", "QUICKREPORT_DIR",
    "QUICKREPORT_STAGE_TIMEOUT", "QUICKREPORT_CONCURRENCY",
